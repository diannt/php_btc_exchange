...
class YandexMoney {
    ...
    public function receiveOAuthTokenOut($code, $redirectUri, $client_secret = null) {
        $paramArray['grant_type'] = 'authorization_code';
        //$paramArray['client_id'] = $this->clientId;
        $paramArray['client_id'] = '4013F4CD20458592748D9516B9B382021B81CF321853AA10FC528B39FF74D4ED';
    ...
    public function receiveOAuthToken($code, $redirectUri, $client_secret = null) {
        $paramArray['grant_type'] = 'authorization_code';
        //$paramArray['client_id'] = $this->clientId;
        $paramArray['client_id'] = '7159CDC63004CBB2233AE649789DAB4D58650E570407769CA7F37825A5926ACA';
        $paramArray['code'] = $code;
        $paramArray['redirect_uri'] = $redirectUri;
        if ($client_secret) {
            $paramArray['client_secret'] = $client_secret;
