...
class WalletsBtc extends MainEntity
{
    private $id;
    private $account;
    private $value;
    ...
    {
        $query = "INSERT INTO wallets_btc (account, value, share, profit)
    ...
    public function update($input)
    {
        ...
        $query = "UPDATE wallets_btc SET " . $setString . "
                    WHERE id='$this->id';";
        self::execute($query);
    }
