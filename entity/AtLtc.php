...
class AtLtc extends MainEntity
{
    private $id;
    private $UID;
    private $address;
    ...
    {
        $query = "INSERT INTO at_ltc (UID, address, type, done, transaction_hash, value, timestamp)
    ...
    public function update($input)
    {
        ...
        $query = "UPDATE at_ltc SET " . $setString . "
                    WHERE id='$this->id';";
        self::execute($query);
    }
